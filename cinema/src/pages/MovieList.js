        ...
        <>
            <main className="flex justify-center">
                <section className="max-w-7xl py-7">
                    <h1 className="b-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white pb-8 text-center">Now Playing</h1>
